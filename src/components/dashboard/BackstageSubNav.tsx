...
export function BackstageSubNav({
  ...
  const { maskSensitiveData, toggleMask } = useMaskSensitiveData();
      ...
      <div className={contained ? 'flex items-center justify-between' : 'max-w-7xl mx-auto flex items-center justify-between'}>
        ...
        <div className="flex items-center gap-2 sm:gap-6 shrink-0">
          ...
          <button
            ...
            title={maskSensitiveData ? 'Mostrar datos sensibles (usuarios y montos)' : 'Ocultar datos sensibles'}
            aria-label={maskSensitiveData ? 'Mostrar datos sensibles' : 'Ocultar datos sensibles'}
          >
            {maskSensitiveData ? (
